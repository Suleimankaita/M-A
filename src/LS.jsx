...
export default function App() {
  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <nav className="bg-white shadow-md fixed w-full top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <ul className="hidden md:flex space-x-8 text-gray-700 font-medium">
            ...
            <li><a href="#" className="hover:text-blue-600">Lessons</a></li>
            <li><a href="#" className="hover:text-blue-600">My Lessons</a></li>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white shadow-md px-6 py-4 space-y-3">
            ...
            <a href="#" className="block text-gray-700 hover:text-blue-600">Lessons</a>
            <a href="#" className="block text-gray-700 hover:text-blue-600">My Lessons</a>
      ...
      {/* Hero Section */}
      <section
        className="bg-cover bg-center pt-28 pb-16 md:py-32"
        style={{
          backgroundImage:
